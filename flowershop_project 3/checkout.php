...
header, footer {
        ...
        /* Footer styling */
        footer {
            background-color: #f8b1c4; /* Matches header color */
            color: #fff;
            text-align: center;
            padding: 10px;
        }
...
<body>
    ...
    <!-- Script for displaying success message -->
    <script>
        window.onload = function() {
            ...
            if (message) {
                ...
                formMessage.textContent = message; // Show the success message
                formMessage.style.display = "block"; // Make it visible
                setTimeout(() => {
                    formMessage.style.opacity = "0";
                    formMessage.style.transition = "opacity 1s ease-in-out";
